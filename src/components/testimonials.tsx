...
const cardsData: TestimonialCard[] = [
  {
    ...
    handle: '@alexeducates',
    date: 'March 15, 2025',
    content: 'LevelUpED revolutionized how I teach—students are actually excited about lessons!'
  },
  {
    ...
    handle: '@lisalearns',
    date: 'April 8, 2025',
    content: 'The interactive quizzes and rewards kept me engaged throughout the course.'
  },
  {
    image: 'https://api.dicebear.com/7.x/avataaars/svg?seed=DavidKim',
    name: 'David Kim',
    handle: '@davidteaches',
    date: 'May 22, 2025',
    content: 'LevelUpED\'s analytics helped me track student progress like never before.'
  },
  {
    image: 'https://api.dicebear.com/7.x/avataaars/svg?seed=SophiaPatel',
    name: 'Sophia Patel',
    handle: '@sophiaedtech',
    date: 'June 12, 2025',
    content: 'From boring lectures to gamified adventures—LevelUpED changed everything!'
  },
]

export default function Testimonials() {
  const [doubledCards, setDoubledCards] = useState<TestimonialCard[]>([])

  useEffect(() => {
    // Duplicate the cards for seamless marquee looping
    setDoubledCards([...cardsData, ...cardsData])
  }, [])
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Hear from educators and learners who have experienced the LevelUpED difference.
          </p>
        </div>
